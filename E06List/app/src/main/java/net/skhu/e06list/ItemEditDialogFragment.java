...
public class ItemEditDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final EditText editText_createDate = (EditText)rootView.findViewById(R.id.editText_createTime); // 데이터 항목의 내용을 EditText에 채운다.

        editText_title.setText(item.getTitle());
        editText_createDate.setText(item.getCreateTimeFormatted()); // 자동으로 생성된 뷰 객체들을 대화상자에 추가한다
